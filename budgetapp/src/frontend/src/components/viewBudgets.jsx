...
function App(props) {
  ...
  function setBudget(newBudget, target, bStart, bEnd) {
    ...
    for (let i = 1; i < numBudgets + 1; i++) {
      if (i !== target) {
        document.getElementById('SSBI' + i).style.backgroundColor =
          'rgb(230, 230, 230)'
      } else {
        document.getElementById('SSBI' + i).style.backgroundColor =
          'rgba(188, 139, 201, 0.651)'
      }
    }
    setExisting(budget)
    setStart(bStart)
        ...
        return (
          <div className='viewBudgetsMain'>
            <button
              ...
              className='viewBudgetsBackButton'
            >
              {'< Back'}
            </button>
            ...
            <div className='viewBudgetsMain'>
              ...
              <div className='viewBudgetBudgetsContainer'>
                ...
                <button
                  onClick={() =>
                    setBudget('January', '1', '2022-01-02', '2022-03-12')
                  }
                  className='viewBudgetBudgetsContainerItemOutline'
                  id={'SSBI' + '1'}
                >
                  <SSBudgetItem
                    name='January'
                    dateperiod='03-01-22 -> 04-01-22'
                  ></SSBudgetItem>
                </button>
                <button
                  onClick={() =>
                    setBudget('February', '2', '12-01-22', '12-02-22')
                  }
                  className='viewBudgetBudgetsContainerItemOutline'
                  id={'SSBI' + '2'}
                >
                  <SSBudgetItem
                    name='February'
                    dateperiod='01-01-22 -> 04-01-22'
                  ></SSBudgetItem>
                </button>
                <button
                  onClick={() =>
                    setBudget('March', '3', '13-01-22', '13-02-22')
                  }
                  className='viewBudgetBudgetsContainerItemOutline'
                  id={'SSBI' + '3'}
                >
                  <SSBudgetItem
                    name='March'
                    dateperiod='04-01-22 -> 12-01-22'
                  ></SSBudgetItem>
                </button>
                <button
                  onClick={() =>
                    setBudget('April', '4', '14-01-22', '14-02-22')
                  }
                  className='viewBudgetBudgetsContainerItemOutline'
                  id={'SSBI' + '4'}
                >
                  <SSBudgetItem
                    name='April'
                    dateperiod='05-01-22 -> 16-01-22'
                  ></SSBudgetItem>
                </button>
                <button
                  onClick={() => setBudget('June', '5', '21-01-22', '15-02-22')}
                  className='viewBudgetBudgetsContainerItemOutline'
                  id={'SSBI' + '5'}
                >
                  <SSBudgetItem
                    name='June'
                    dateperiod='21-01-22 -> 13-02-22'
                  ></SSBudgetItem>
                </button>
              </div>
              ...
              <button
                onClick={() => setScreen(1)}
                className='viewBudgetBudgetviewButton'
              >
                Edit Budget
              </button>
            </div>
  ...
  return microControllerScreenReturn()
}
