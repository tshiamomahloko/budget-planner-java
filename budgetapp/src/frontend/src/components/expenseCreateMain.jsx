...
<button onClick={() => props.FECresponse2()} className="incomeSelectorI">Income</button>
<button className="expenseSelectorA">Expense</button>
   ...
   <button onClick={() => props.FECresponse1()} className="exportBudgetsBackButton">
    ...
    <button className="incExpConfirmButton" >Add Expense</button>
    </div>
  );
}
